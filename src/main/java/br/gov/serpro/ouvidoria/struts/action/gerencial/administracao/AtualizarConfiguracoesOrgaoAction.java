...
public class AtualizarConfiguracoesOrgaoAction extends DispatchActionSupport {
    ...
    public ActionForward salvar(ActionMapping mapping, ActionForm form,
        ...
        if(notificacaoEmail==null || notificacaoEmail.equals("")){
        	...
        	boolean agendamentoFinalizado = false;

        	if (OuvidoriaScheduler.sched != null) {
        		agendamentoFinalizado = OuvidoriaScheduler.sched.deleteJob( "EnviarAlertaJob", Scheduler.DEFAULT_GROUP);
        	}
    ...
    protected static Logger getLog() {
		...
		if (logger == null) {
			logger = Logger.getLogger("OuvidoriaScheduler ------> ");
		}
		return logger;
	}
