...
public class ConsultarAndamentoSolucaoDetailAction extends ActionSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Obtêm o nome do diretório da aplicação para concatenar ao local onde os anexos estão
			String nomeAplicacao = Utilitario.obterContextoAplicacao(getDaoFactory());
			
			// Forma a URL base do anexo
			String caminho = "/"
					.concat(nomeAplicacao)
					.concat("/")
					.concat("anexos/")
					.concat(this.getOrgao(request).getConfiguracoes()
