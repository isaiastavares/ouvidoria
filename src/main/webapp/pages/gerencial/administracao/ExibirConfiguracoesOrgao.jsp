    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            if (document.getElementById("permiteArquivoAnexoAcionamento").checked ) {
            	innerHtmlMsgErros += CriticaNumero( document.forms[0].elements["tamanhoMaxArquivoAnexo"]            , 1, 7, 0, 'Tamanho máximo para arquivo anexo' );
            }
                            ...
                            <img accesskey="d" tabindex="2" name="imgDetalhe" id="imgDetalhe" src="../../<bean:write name="_LAYOUT_"  property="esquemaCores"/>/pasta_detalha.gif" alt="Configurações do Órgão Escolhido"><table cellpadding="2" cellspacing="1" border="0" align="center" width="100%">
                                ...
                                <tr>
                                    <td colspan="1" class="tdHeader3">
                                        <label for="linkImagemBanner">
                                            Link para a imagem do banner do órgão&nbsp;<font class="asterisco">*</font><br>
                                ...
                                <tr>
                                    ...
                                    <td id="idTamanhoMaxArquivoAnexo" class="tdHeader4" width="15%"> 
                                        <html:text styleId="tamanhoMaxArquivoAnexo" tabindex="46" size="12" maxlength="7" name="configuracoes" property="tamanhoMaxArquivoAnexo"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td id="idTamanhoMaxArquivoCartaDigitalizada" class="tdHeader4" width="15%"> 
                                        <html:text styleId="tamanhoMaxArquivoCartaDigitalizada" tabindex="48" size="12" maxlength="7" name="configuracoes" property="tamanhoMaxArquivoCartaDigitalizada"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="1" class="tdHeader3">
                                        <label for="nomeDiretorioOrgao">Nome do diretório do órgão&nbsp;<font class="asterisco">*</font></label>
                                    </td>
                                    <td colspan="3" class="tdHeader4"> 
